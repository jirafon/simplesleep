...
function OrdenHombre() {
  ...
  const examOptions = [
    ...
    { id: 'lab-30', name: 'Antígeno Prostático Específico', category: 'Laboratorio', price: 3990 },
    { id: 'lab-31', name: 'Test de hemorragias ocultas en deposiciones', category: 'Laboratorio', price: 2990 },
    { id: 'lab-32', name: 'Grupo Sanguíneo (ABO y Rh)', category: 'Laboratorio', price: 1990 },
    ...
    { id: 'lab-54', name: 'Test de ELISA para VIH', category: 'Laboratorio', price: 2990 },
    { id: 'lab-55', name: 'Test de Elisa para VHC', category: 'Laboratorio', price: 2990 },
    { id: 'lab-56', name: 'Antígeno Prostático Específico', category: 'Laboratorio', price: 3990 },
    
    // Imágenes y otros
    { id: 'img-1', name: 'Ecografía Abdominal', category: 'Imágenes y otros', price: 3990 },
    { id: 'img-2', name: 'Densitometría ósea', category: 'Imágenes y otros', price: 4990 },
    { id: 'img-3', name: 'Ecografía de Tiroides', category: 'Imágenes y otros', price: 3990 },
    { id: 'img-4', name: 'Ecografía Renal Preventiva', category: 'Imágenes y otros', price: 3990 },
    { id: 'img-5', name: 'Ecografía Doppler de Carótidas', category: 'Imágenes y otros', price: 4990 },
    { id: 'img-6', name: 'Ecografía Cardíaca Doppler transtorácica', category: 'Imágenes y otros', price: 5990 },
    { id: 'img-7', name: 'Ecografía de Hígado', category: 'Imágenes y otros', price: 3990 }
  ...
  const handleAddSelectedToCart = () => {
    ...
    if (addedCount > 0) {
      setMessage({ type: 'success', text: `${addedCount} examen${addedCount > 1 ? 'es' : ''} agregado${addedCount > 1 ? 's' : ''} al carrito` });
      setSelectedExams([]);
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-blue-900 text-white p-8 md:p-10 mb-8 shadow-xl">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            <div>
              <p className="uppercase tracking-[0.2em] text-xs text-blue-200 mb-3">Orden Hombre</p>
