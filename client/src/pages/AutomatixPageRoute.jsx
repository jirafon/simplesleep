...
import AutomatixPage from '../components/AutomatixPage';
...
function AutomatixPageRoute() {
  ...
  return (
    <div className="bg-black min-h-screen font-sans antialiased pt-20 md:pt-24">
      ...
      <AutomatixPage onOpenDemo={handleOpenDemoModal} />
      <Footer />
...
export default AutomatixPageRoute;
