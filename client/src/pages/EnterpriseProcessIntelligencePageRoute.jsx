...
import EnterpriseProcessIntelligencePage from '../components/EnterpriseProcessIntelligencePage';
...
function EnterpriseProcessIntelligencePageRoute() {
  ...
  return (
    <div className="bg-black min-h-screen font-sans antialiased pt-20 md:pt-24">
      ...
      <EnterpriseProcessIntelligencePage onOpenDemo={handleOpenDemoModal} />
      <Footer />
...
export default EnterpriseProcessIntelligencePageRoute;
