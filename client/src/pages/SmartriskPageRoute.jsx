...
import SmartriskPage from '../components/SmartriskPage';
...
function SmartriskPageRoute() {
  ...
  return (
    <div className="bg-black min-h-screen font-sans antialiased pt-20 md:pt-24">
      ...
      <SmartriskPage onOpenDemo={handleOpenDemoModal} />
      <Footer />
...
export default SmartriskPageRoute;
