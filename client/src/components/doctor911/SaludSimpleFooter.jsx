        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Resultados que hacen la diferencia. Accesibles 24/7 con cobertura nacional.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link to="/quienes-somos" className="hover:text-white transition">
                  Quienes Somos
                </Link>
              </li>
...
export default SiempreSaludFooter;
export { SiempreSaludFooter as SaludSimpleFooter };
